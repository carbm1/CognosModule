...
function Get-CogSqlData {
    ...
    Param(
        ...
        'TAC_SEAT_PER_HDR','TACTB_ISSUE','TACTB_ISSUE_ACTION','TACTB_ISSUE_LOCATION','tmp_medtb_vis_exam_ark','WSSecAuthenticationLogTbl',<#eFinance#>'aca_1094load','aca_1094loadsave','aca_1094payrun',
        'aca_aggregate_ale','aca_ben_class','aca_ben_deduct','aca_ben_grps','aca_benefit_status','aca_code_table','aca_cov_ind','aca_empl_ovrd','aca_employee','aca_employer',
        'aca_hrs_conversion','aca_load','aca_prt_setup','aca_xml_track','acct4table','accttype','activtbl','actor','adb_chart_config','adb_dashboard','adb_data_source','adb_migration',
        'adb_user_dashboard','adb_widget','adb_widget_type','add_rate','addempldetail','addemplroles','addemplsec','addemplsteps','addemplusers','addrbk','adjust_data','adv_pay',
        'aesattend','aesmask','aespaytab','alt_vend_addr','alt_vnd_misc','AMApplicantCertType','AMApplicantDefinition','AMApplicantEducation','AMApplicantEEO','AMApplicantEEOCodes',
        'AMApplicantExperience','AMApplicantGallupMaster','AMApplicantGallupResults','AMApplicantInterview','AMApplicantReference','AMApplicantSkill','AMApplication','AMApplicationCategory'
        ,'AMApplicationChecklist','AMApplicationDisposition','AMApplicationHistory','AMApplicationNotes','AMApplicationResponses','AMCodes','AMEmailTemplate','AMGallup','AMGallupHistory'
        ,'AMHAViewConfiguration','AMHireRecommendation','AMLicenseCertificate','amort_sched','AMPostAprv','AMPostAprvHist','AMPostingCertificates','AMPostingDefinition','AMPostingDistOrgn'
        ,'AMPostingDistProj','AMPostingDistribution','AMPostingHistory','AMPostingNotifications','AMPostingQuestionCategory','AMPostingQuestionDefinition','AMPostingQuestionDetails',
        'AMPostingQuestionResponseDef','AMPostingReasons','AMPostingSpecificQuestions','AMPostingTransfer','AMPostingTransferEFP','AMPostRequestEFP','AMQuestionCategory',
        'AMQuestionDefinition','AMQuestionDetails','AMQuestionResponseDefinition','AMSetting','AMStaticCodes','AMVerificationResponseHistory','AMWorkHistory','apacctappr','apaprv',
        'app_certificate','app_def','app_degree','app_misc','app_races','app_ref','app_reference','app_supplement','applicant','appracct','apprdetl','approval','appuser','asntable',
        'AspNetRoles','AspNetUserClaims','AspNetUserRoles','AspNetUsers','asset_fund_if','assetif','assets','assign_tbl','assignment','assoc_approvers','assoc_rulegroups','assoc_workflow',
        'at_permissions','attach_detail','attach_master','attend','audit1099','audit1099r','audittrails','auto_check_no','auto_num','b_app_certificate','b_app_degree','b_applicant',
        'b_asset','b_enr_contben','b_posnpref','b_prevposn','backord','backup_checksum','backup_log','bank_layout','bankacct','bartable','batchpay','bb_audit','bb_email','bb_employee',
        'bb_erp_orders','bb_notify','bb_profile','bb_runtbl','bb_transact','bbenefici','bbenefits','bchgstat','bdedtable','bdeduct','bdemo','bdependent','bdist_orgn','bdist_proj',
        'bemp_course_costs','bemp_course_cred','bemp_course_dtl','bemp_course_goal','bemp_course_misc','bemp_course_topic','bempact','bempl_races','ben_benefici','ben_benefits',
        'ben_chrg_override','ben_deduct','ben_dependent','ben_emplinfo','benclass','benefici','beneficiorg','benefits','benefitsorg','bentable','bentype_tb','bexpledgr','bfe2table',
        'bfedtable','bfictable','bid_class','bid_detl','bid_hdr','bid_preenc','bid_price','bid_template','bidchrg','bidtype','bk_adv_pay','bk_assoc_approvers','bk_assoc_rulegroup',
        'bk_assoc_workflow','bk_attend','bk_dedaddend','bk_dedtable','bk_deduct','bk_empuser','bk_menu_applications','bk_menu_groups','bk_menu_options','bk_menu_tabs','bk_pay2file',
        'bk_payaddend','bk_paycode','bk_payfile','bk_paygroups','bk_payrate','bk_payroll','bk_position','bk_posn_data2','bk_posn_data3','bk_predist','bk_rule_definition','bk_rule_group',
        'bk_sumdetdist','bk_sumfiscdist','bk_task_cond_val','bk_task_condition','bk_task_table','bk_timecard','bk_wkrdept','bk_wkrtable','bkup_assoc_apprvrs','bkup_assoc_rulegrp',
        'bkup_assoc_wkf','bkup_rule_def','bkup_rule_group','bkup_task_cond','bkup_task_cond_val','bkup_task_table','blo2table','blo3table','bloctable','bnk_fld_name','bnktable',
        'bond','bondinfo','bpayrate','bpctl_orgn','bpctl_proj','bposition','bposn_cert','bposn_data2','bposn_data3','bposn_qual','bposn_req','bproj_title','bproledgr','brevledgr',
        'brstable','bshdtable','bst2table','bst3table','bsttable','btaxinfo','btimecard','btrans_acct','bubudacct','bubudorgn','bubudproj','bud_prof','budacctappr','budactv','budaprv',
        'budaprvhist','buddist','budincr','budpayr','budposn','budpost','bulk_sync_status','business_rule_entity','business_rule_hdr','business_rule_type','bvenclass','calendar',
        'capital','cashbhis','cashbond','cashbpro','category','cert_area','cert_type','chart_type','check_ded','check_leave','check_paycode','check_record','check_ytd','checkhi2',
        'checkhis','checkrec','chgactap','chgactap_hist','chgaprv','chgaprv_hist','chgchrg','chgcomm','chgcomnt','chglinds','chgorder','chgtaxes','chkstat','clsincr','clstable',
        'clstable_data2','cob_act','cob_his','cobra','code_crosswalk','color_table','comdesc','comhist','commod','comstkno','comtext','cont_misc_fields','contract_adjust',
        'contract_type_tbl','contract_type_tbl2','courthis','courtpro','courtreg','crdc_bldmnt','crdc_cert_type','crdc_de_xwalk','crdc_distcfg','crdc_employee','crdc_fedfund',
        'crdc_jp_xwalk','crdc_lastcalc','crdc_levtable','crdc_locn','crdc_lv_hist','crn_cfg','crn_cfg_renamed','cross_def','ct3inter','cxbudacct','cxbudorgn','dash_detail',
        'dash_detail_data','dash_detail_qry','dash_header','dash_master','dash_master_data','dash_master_qry','dash_run','data_mask','dcert_area','dcert_type','dclstable',
        'ddegtable','dedaddend','dedfreqtable','dedtable','dedtbl_web','deduct','def_comp','defined','deglevtable','degsubject','degtable','dencumbr','department','dependent',
        'dependentorg','dephist','dept','detdist','detdist_ben_ovrd','dexpledgr','dinvrecom','dinvreq','dinvtran','dist_cell','dist_orgn','dist_proj','distdesc','distdetl',
        'district_entity','djournal','djournal_override','dlevtable','dmanchk','dpayable','dpayable_head','dpaytable','dreceipt','dreceive','dregtb_building','dschool','dsubject',
        'dt_levtable','dtytable','dvendor','eac_deplink','eac_enr_benefici','eac_enr_benefits','eac_enr_confirm','eac_enr_contben','eac_enr_deduct','eac_enr_questions',
        'eac_enr_timestamp','eac_linkdedquest','eac_nh_effdate','eac_questiongroups','ear_assetif','ear_atrs_empr','ear_calenpay','ear_clstable','ear_cont_detail','ear_dedtable',
        'ear_emp_contract','ear_fam_prof','ear_health','ear_hrm_chrg','ear_inv_prof','ear_levtable','ear_old_limit','ear_pbsuser','ear_purchase','ear_qtr_retire','ear_retro_calc',
        'ear_retro_class','ear_retro_grps','ear_retro_rate','ear_trs_data','ear_trs_load','ebd_count','ebd_daily','ebd_error','econtdat','econtdef','econtempl','econtempldat',
        'econtprof','edgecustlinks','efp_profile','eft_dest','eic2tabl','eictable','emp_certificate','emp_costtype_tbl','emp_course_costs','emp_course_cred','emp_course_dtl',
        'emp_course_goal','emp_course_misc','emp_course_topic','emp_credential','emp_crs_misc_lbl','emp_crs_stat_tbl','emp_crs_type_tbl','emp_degree','emp_license','emp_qual_notes',
        'emp_qualify','emp_require','empact','empl_privacy','empl_races','empl_staff','emplinfo','employee','employee_renamed','employee_type','emplsoundex','empuser','empuser_snapshot',
        'encdist','encledgr','enctaxes','enr_contben','enroll_confirm','ent_allow_accounts','ent_allow_budaccts','ent_allow_budorgns','ent_allow_orgns','entity_types','epay_banks',
        'epay_format','epay_type','esc_employee','esc_prof','esmfiscal','esmpo','esmpochrg','esmpoit','esmreqchrg','esmrequ','et_crosswalk','ethnic_table','ets_action_codes',
        'ets_actions','ets_dist_depts','ets_distributions','ets_except_list','ets_notify','ets_schdept','ets_sched_days','ets_schedule','etx_clstable','etx_paytable','ex_curricular',
        'exceltasks','expbudgt','expense_AprvHist','expense_category','expense_detail','expense_header','expense_type','expledgr','expnotes','f_profact','faaccount','fam_grd',
        'fam_locn','fam_prof','fam_ref','famstate','famwork_activities','famwork_notifyhist','famworkflow_guids','famworkflow_log','faorgn','faproject','faworkactivityhist',
        'faworknotification','fe2table','fed_race_codes','fed_tax_calc','fedtable','fictable','filing_type','finauditlinks','finaudittrail','fincustom','fips_codes','fix_def',
        'fix_locn','fix_num','fix_prof','fix_ref','fixuser','flsa_cycle_setup','flsa_payroll','fm_format_defaults','fms_user_fields','fms_user_rules','fms_user_rules_messages',
        'fms_user_screen','fmsnxtno','functbl','fundtable','fxhist','fxhistmult','fxinv_upd','gasb_fx','gender_identity_tbl','genledgr','global_search','global_user_sso_mapping',
        'grplife','grplifew2','hdeduct','hemployee','hemployee_renamed','holiday','home_fav_groups','home_fav_items','home_panel_types','home_session_docs','home_user_panel',
        'home_user_ses_hist','home_user_session','home_user_tab','hpayrate','hpayroll','hq_credential','hq_method','hq_qualify','hq_require','hq_status','hrm_aca_audit',
        'hrm_aca_hours','hrm_locn','hrm_prof','hrm_user_employee','hrmstate','hrmstate2','hrmwork_activities','hrmwork_notifyhist','hrmworkflow_guids','hrmworkflow_log',
        'hrworkactivityhist','hrworknotification','icalendar','icma_date','icma_setup','import_empuser','importmapdetail','importmapheader','importmapstatic','infunds','inhistdtl',
        'inhistory','inprofile','ins_user','instb_screen','instb_screen_spec','intacct','integration_errors','integration_errors_renamed','integration_fields','interface_setup',
        'interfund_bal_walk','interviewer','intransact','intransdtl','intranstyp','inuse_check_no','inuse_no','inuse_payable','inv_prof','invaudit','invcomm','investment',
        'invlocn','invrecom','invreq','invtory','invtran','invtype','invuse','irs_country_codes','ischedule','it_audit','it_expledgr','it_phase','it_proledgr','it_psavdist',
        'it_revledgr','it_stat','iteration','iternote','itimecard','jac_employee','je_nums','jeaprv_hist','jenote','job_data','job_inv','job_master','job_tabl','jobcategory',
        'jobopening','jobtable','kpi_criteria','kpi_expbudact','lastcalc','leaveaprv','leaveaprv_hist','leaverequest','levtable','libattachstatus','libcolcheck','librefcolumns',
        'libreftables','lo2table','lo3table','loc_cross','location','loctable','log_detail','log_header','lts_tabl','mailmess','majmin','mapckhld','mapckhst','mchkhist','mchkhld',
        'menu_applications','menu_custom_opts','menu_groups','menu_options','menu_options_lic','menu_persnl_grps','menu_persnl_opts','menu_tabs','menutb_activity','menutb_cfg',
        'menutb_items','menutb_lock','menutb_printers','menutb_rebuild','menutb_termtype','menutb_titles','menutool','menutool_groups','menutool_items','migration','mmax_bpayrate',
        'mmax_budpr','mmax_hpayrate','mmax_payrate','mmax_prct','mncknote','mrapcrdetail','mrapcrdistrb','mrapcrhead','mrbillitem','mrbinvdetl','mrbinvdistrb','mrbinvhead',
        'mrbrefund','mrcategory','mrclnttype','mrcustaddr','mrcustbill','mrcustomer','mrcustservice','mrdfltcust','mrdfltform','mrdistdesc','mrdistdetl','mrdtnote','mrdunning',
        'mrhdnote','mrhistory','mrinterest','mrjournal','mrminvdetl','mrminvdistrb','mrminvhead','mrnxtnum','mrobajdetl','mrobajdistrb','mrobajhead','mroinvdetl','mroinvdistrb',
        'mroinvhead','mropdistrb','mropenitem','mrowofdetail','mrowofdistrb','mrowofhead','mrpadjdetail','mrpadjdistrb','mrpadjhead','mrpenalty','mrprofile','mrrcpbatch',
        'mrrcpbdetail','mrrcpbhead','mrrcpidetail','mrrcpihead','mrrcptdetail','mrrcptdistrb','mrrcpthead','mrrefund','mrrinvdetl','mrrinvdistrb','mrrinvhead','mrsalestax',
        'mrservice','mrterms','multiasset','netdist','netdist2','newhire','newhire_data2','newhireaprv','newhireaprv_hist','newhirenotf','newhireupdt','newhireverf','non_work',
        'note_pad','notificationcert','notifier','notify_templates','notify_type','nyr_fund','obj_table','obj_type','ojournal','old_activity','old_assets','old_department',
        'old_multiftbl','old_source','opayable','optio_manager','oreceipt','oreceive','orgbudexp','orgbudrev','orgn1table','orgn2table','orgn3table','orgn4table','orgn5table',
        'orgn6table','orgn7table','orgn8table','orgn9table','otherins','output_detail','output_master','ovendor','P360_NotificationLink','P360_NotificationResultSet',
        'P360_NotificationResultSetUser','P360_NotificationRule','P360_NotificationRuleKey','P360_NotificationRuleUser','P360_NotificationSchedule','P360_NotificationTasks',
        'P360_NotificationUserCriteria','padd_rate','password_requests','pat_act','pat_sit','pay_code','pay_freq','pay_log','pay_runf','pay_stax','pay2file','payab_asset',
        'payable','payaddend','paybnote','paychk_sel','paycode','payee','payer','payf_cp','payfile','paygroups','paygrp_defdays','payrate','payrhist','payroll','paytab_activity',
        'paytable','pb_audit','pb_iteration','pb_iternote','pbi_budactv','pbi_buddist','pbi_budincr','pbi_budpayr','pbi_mmax_budpr','pbi_padd_rate','pbi_pclstable','pbi_pdedtable',
        'pbi_pdeduct','pbi_pdist_orgn','pbi_pdist_proj','pbi_pdtytable','pbi_pfictable','pbi_ppaytable','pbi_ppctl_orgn','pbi_ppctl_proj','pbi_pposition','pbi_pposn_data2',
        'pbi_pposprate','pbi_pwkrtable','pbs_state','pcash_acctmask','pcash_funds','pcash_header','pcd_cards','pcd_crosswalk','pcd_data_items','pcd_dist','pcd_enc_no','pcd_entry',
        'pcd_fld_formats','pcd_layout_flds','pcd_layout_hdr','pcd_profile','pcd_trans','pcd_transact','pcd_users','pcd_vendors','pclstable','pclstable_data2','pctl_orgn',
        'pctl_proj','pd_area_dtl','pd_area_mstr','pd_attend_dtl','pd_catg_mstr','pd_class_dtl','pd_cost_dtl','pd_cost_mstr','pd_course_emp_type','pd_course_mstr','pd_coursemisc_dtl',
        'pd_coursetype_mstr','pd_credit_dtl','pd_credit_table','pd_credittype_mstr','pd_eval_dtl','pd_eval_mstr','pd_grade_type_dtl','pd_grade_type_mstr','pd_inst_part_mstr',
        'pd_location','pd_location_room','pd_misc_mstr','pd_misc_type_mstr','pd_prereq_dtl','pd_reg_dtl','pd_req_dtl','pd_req_mstr','pd_resp_dtl','pd_term_mstr','pdedtable',
        'pdeduct','pdist_orgn','pdist_proj','pdtytable','pei_background','pers_history','person','person_cont_type','pfictable','pk_problems','poacctap','poacctap_hist',
        'poaprv','poaprv_hist','pocomnt','polinds','portfolio','posdeg_link','positiondata','posn_cert','posn_data2','posn_data3','posn_qual','posn_req','posnhist','posnpref',
        'posprate','potext','potype','ppaytable','ppctl_orgn','ppctl_proj','pposition','pposn_data2','pposn_data3','pposprate','predist','prevposn','proc_detail','proc_header',
        'proj_def','proj_title','projuser','proledgr','pronotes','psavdist','ptr_ctrl','publish_to_entities','publish_to_entities_log','pur_app_defaults','pur_ship_defaults',
        'purchase','purchase_approvals','purchrg','purcomm','purcvhis','purcvnot','purge_add_rate','purge_dist_orgn','purge_dist_proj','purge_elig_payrate','purge_empuser',
        'purge_memsrstabl','purge_mmax_payrate','purge_payrate','purge_posprate','purtaxes','pwkrtable','qual_type','racetable','recdeposit','recledgr','recon_adjust',
        'recon_deposit','recon_hdr','recon_je','recon_payment','recon_payroll','recon_raw','recon_setup','reconcile','recvnote','reftb_collateral','regtb_building',
        'req_autoconvert','reqaprv','reqaprv_hist','reqchrg','reqcomm','reqcomnt','reqlinds','reqtaxes','requisit','requisit_approvals','retclass','retro_log','retro_paycodes',
        'rev_deduct','revledgr','revnotes','role_assign','role_dept','rpt_head','rptcol','rptlayout','rptline','rptmaint','rqacctap','rqacctap_hist','rsn_tabl','rstable',
        'rule_definitions','rule_group','rule_groupdata2','sal_inc','salsch_code','school','screen_attr_additions','screen_attr_tbl','screen_desc','search_detail','search_groupkeys',
        'search_groups','search_header','search_keys','search_nxtno','sec_user_menu_cache','sectb_access','sectb_action_feature','sectb_action_resource','sectb_adgroups',
        'sectb_attachaccess','sectb_crosswalk','sectb_delegate','sectb_license','sectb_package','sectb_privilege','sectb_profile','sectb_resource','sectb_roleaccess','sectb_roles',
        'sectb_roleusers','sectb_subpack','sectb_user','sectb_usrviw','secure_elements','senior','setup_g','setup_int','setup_misc','setup1099','sfattend','sfe_accountmask',
        'sfe_business_rules','sfe_classification_mapping','sfe_criteria_mapping','sfe_crosswalk','sfe_location_crosswalk','sfe_rule_history','sfe_rule_match_hist',
        'sfe_sub_vacancy_table','sfe_sub_vacancy_table_renamed','sfe_work_hours','sftimecrd','shared_info','shared_info_hist','shdtable','shipping','sif_assignment',
        'sif_event_det','sif_event_hdr','sif_guid_emp','sif_guid_empasgn','sif_guid_loc','sif_guid_staff','sif_guid_staffasgn','sif_publish','sif_subscribe','sis_staffrules',
        'site_info','sjournal','source','sourceamt','spayable','spi_code_in_use','spi_code_in_use_filter','spi_column_control','spi_column_info','spi_column_names',
        'spi_column_validation','spi_conv_codes','SPI_INTEGRATION_DET','SPI_INTEGRATION_HDR','SPI_INTEGRATION_LOGIN','SPI_INTEGRATION_SESSION_DET','SPI_INTEGRATION_SESSION_HDR',
        'spi_option_column_nullable','spi_option_excld','spi_option_list_field','spi_option_name','spi_option_simple_search','spi_option_table','spi_option_update','spi_search_fav',
        'spi_search_fav_subscribe','spi_table_join','spi_table_names','spi_user_search','spi_user_search_list_field','spi_user_sort','spi_validation_tables','spilicense',
        'spitb_search_fav_category','st2table','st3table','state_clstable','state_levtable','state_list_bucket','state_list_item','state_paytable','states','stathist','statustb',
        'sttable','stu_course','stu_qualif','stu_staff','stuact_code','stuact_ledger','stuact_locn_act','stuact_sponsor','stuact_sponsr_perm','stuact_trans_audit','stuact_trans_notes',
        'stuact_transact','sub_classes','sub1table','sub2table','sub3table','subject','subtypetable','suffix_table','sumdetdist','sumfiscdist','sumfiscliab','sv_search_detail',
        'sv_search_master','systb_columns','systb_tables','system_void_chk','t_app_time','t_applicant','t_dept','t_detail','t_detnotes','t_employee','t_help','t_levtable',
        't_profile','t_schdept','t_schedule','t_subdept','t_super','t_unapp_codes','t_unapprove','t1099','t99rmain','task_access','task_condition','task_condition_val',
        'task_role','task_table','taxrate','tb_title','tcdc_employee','tcdc_referencetable','te_employee','te_payroll','telquote','temp_items','temp_titl','termaprv',
        'termaprv_hist','termchrg','termcmnt','termcomm','termcont','termempl','termlinds','termnote','tertable','time_att','time_oth','timecard','timecode','timedist','timeeasy',
        'timetable','tmp_rate','tpayfile','tr_apportab','tr_apportwk','tr_balance','tr_cleared','tr_djournal','tr_dreceipt','tr_genledgr','tr_profile','tr_recsetup','tr_transact',
        'tr_warhist','tr_warrants','trans_acct','transact','transledgr','transnotes','tsattend','tsortaddend','tss_emp','tss_sub','tssi_class','tssi_loc','tx_budtstat','upload_detail',
        'upload_header','user_def','user_passthru','user_profile','user_ref','user_sso_mapping','ut_integration_fields','uvadminusers','uvprofile','vac_content','vac_invoice',
        'vac_profile','vac_vendor','vbs_prof','veh_user','vehtb_screen','vehtb_screen_spec','vem_def','vem_prof','vem_ref','vemhist','veminvtran','vemlabor','vemlocn','vemmaincode',
        'vemmaindet','vemmaint','vemninvtran','vemsernotes','vemservord','vemtrans','vemuser','vemvehicle','venact','venbid_alt','venbid_det','venbid_hdr','venchk_proc_tbl','venclass',
        'vendaddr','vendaddr_misc','vendnote','vendor','viewid','vnd_def','vnd_misc','vnd_ssn','vndasoundex','vndnsoundex','vnduser','vpayhist','w2box12','w2box13','w2box14','w2cemp',
        'w2cemployee','w2employee','w2labels','w2load','w2loctx','w4lockin','wartran','wbassign_chg','wbassign_num','wbentrydtl','wbentryhdr','wbposappr','wbposition','wbposreq',
        'wbud_only','wbud_prof','wbudreqappr','wbudreqnote','wbudrequest','wbuduser','wbudvacnote','wea_prof','wea_supplement','web_admin','web_admin_options','web_disclaim','web_link',
        'web_news','web_num','web_prof_cat','web_prof_type','web_profile','web_sec_quest','web_sec_resp','weekend_work','wet_anomalies','wet_app_time','wet_clock_time',
        'wet_clock_time_renamed','wet_comp_time','wet_compot_dist','wet_correct','wet_dept','wet_detail','wet_dist_key','wet_empl_dept','wet_employee','wet_input_days','wet_notes',
        'wet_notify','wet_pay_link','wet_pay_setup','wet_paytable','wet_profile','wet_schdept','wet_schedule','wet_super','wet_unapp_codes','wet_unapprove','wf_app_task',
        'wf_app_task_approvers','wf_application','wf_auditTrails','wf_dataset','wf_delegates','wf_emails','wf_groups','wf_instance','wf_instance_email_notify','wf_instance_event',
        'wf_instance_event_detail','wf_instance_event_notify','wf_launch_types','wf_model','wf_model_node','wf_model_node_detail','wf_model_node_role_groups','wf_model_node_transition',
        'wf_queue','wf_role_members','wf_roles','wf_task','wf_task_queue','wf_task_rule_group','wf_udf_emp_mapping','wf_udf_task_mapping','wf_user_defined','wf_user_defined_hdr',
        'with_rate_sched','wkrdept','wkrtable','work_activities','work_activity_hist','work_app_request','work_notifications','work_notify_hist','workactor','workflow_codes',
        'workflow_config','workflow_correct','workflow_guids','workflow_log','workflow_profile','wrk1099g','wrk1099i','wrk1099m','wrk1099n','wrk1099r','wrkdeduct','wrkemployee',
        'wrkemployer','wrkfica','wrkmain','wrkpaycode')]
        [string]$Table,
    ...
    if ($Table) {
        ...
        # We are no longer using these. We are now looking at the eSchoolModule included information.
    ...
    if ($awesomeSauce) {
        ...
        #Primary Keys need to be specified or we will attempt to pull from the eSchoolModule. This means FMS must be specified.
        if ($PKColumns) {
        ...
        if ($Columns) {
            ...
            $columns = (Get-eSPTableColumns -Table $Table | Where-Object { @('SSN','FMS_EMPL_NUMBER') -notcontains $PSItem }) -join ','
            $params.reportparams += "&p_colSpecify=$($Columns)"
        }
